...
// document.querySelector('.close-mobile-menu').addEventListener
// ('click', () => {
...
// ('click', () => {
//     document.querySelector('#mobile-menu').classList.add
//     ('active');
// })
...
const mobileModeOn = () => {
    if(window.innerWidth <= 991) {
        document.querySelector('header .menu').classList.add
        ('mobile-mode');
    } else {
        document.querySelector('header .menu').classList.remove
        ('mobile-mode');
    }
};
mobileModeOn();
